...
import "../../../components/languages/html+ts.astro"
...
const editors = mountEditorsUnder<MyOptions>(
	document,
	options => {
		return matchBrackets(true, options._pairs)
	}
)
```
