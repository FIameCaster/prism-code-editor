...
- [React rewrite](https://github.com/FIameCaster/prism-code-editor/tree/main/react-package)
- [SolidJS rewrite](https://github.com/FIameCaster/prism-code-editor/tree/main/solid-package)
