...
<Editor language="javascript" value={`import "prism-code-editor/prism/languages/markdown"
...
<Editor language="javascript" value={`import "prism-code-editor/prism/languages/typescript"
...
<Editor language="javascript" value={`import { languages } from "prism-code-editor/prism"
