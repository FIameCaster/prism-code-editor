 ...
 * To provide completion for events, prefix them with `on`. E.g. `onevent` will result
 * in completions for `@event` or `v-on:event`. Camel cased props are not converted to
 * kebab case.
